    ...
    <div className="min-h-screen bg-app-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <nav className="flex items-center gap-2 text-sm text-app-text-light mb-6">
          ...
          <span className="text-app-green font-medium truncate max-w-[200px] capitalize">
            {product.name}
          </span>
        </nav>
          ...
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="relative flex items-center justify-center p-8 md:p-12 min-h-[320px] md:min-h-[480px]">
              ...
              <div className="absolute top-5 left-5 flex flex-wrap gap-1.5">
                {product.isOrganic && (
                  <span className="px-2.5 py-1 text-xs font-semibold bg-app-green text-white rounded-full flex items-center gap-1">
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center">
              ...
              <div className="flex items-baseline gap-3 mb-5">
                ...
                {product.originalPrice > product.price && (
                  <span className="text-lg text-app-light line-through">
                    {" "}
                    {currency}
