            ...
            {loading ? (
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                        ...
                        <div className="md:col-span-2">
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                ...
                                <div className="flex-1 w-full space-y-2">
                                    <input type="file" accept="image/*" onChange={e => setImageFile(e.target.files?.[0] || null)} className="w-full px-4 py-2 text-xs rounded-lg border border-zinc-200 focus:border-app-green outline-none transition-all file:mr-4 file:py-1.5 file:px-3 file:rounded-lg file:border-0 file:text-xs file:font-medium file:bg-app-orange file:text-white hover:file:bg-orange-600 cursor-pointer" />
                                    <input type="text" placeholder="Or paste image URL (https://...)" value={formData.image} onChange={e => setFormData({ ...formData, image: e.target.value })} className="w-full px-4 py-2 text-xs rounded-lg border border-zinc-200 focus:border-app-green outline-none transition-all" />
                                </div>
                            </div>
                        </div>
                        <div className="md:col-span-2">
                    ...
                    <div className="pt-6 border-t border-app-border flex justify-end">
                        <button disabled={saving} type="submit" className="px-6 py-2.5 bg-app-orange text-white font-medium rounded-lg hover:bg-orange-600 transition-colors disabled:opacity-50 cursor-pointer">
